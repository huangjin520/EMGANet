...
"""jin 后面全是数据增强"""
train_img_paths = glob("/mnt/Disk1/huangjin/breast_ultrasound/JIN_Work_algorithm/dataset_public/Dataset_BUSI_with_GT/BUSI_train_test/train/img/ori/*.bmp")
train_gt_paths  = glob("/mnt/Disk1/huangjin/breast_ultrasound/JIN_Work_algorithm/dataset_public/Dataset_BUSI_with_GT/BUSI_train_test/train/gt/ori/*.bmp")
...
for i in range(len(train_img_paths)):
    ...
    img1_img_path = os.path.join(r"/mnt/Disk1/huangjin/breast_ultrasound/JIN_Work_algorithm/dataset_public/Dataset_BUSI_with_GT/BUSI_train_test/train/img/augment", "Contrast1_"+train_img_name)
    img1_gt_path = os.path.join(r"/mnt/Disk1/huangjin/breast_ultrasound/JIN_Work_algorithm/dataset_public/Dataset_BUSI_with_GT/BUSI_train_test/train/gt/augment", "Contrast1_"+ train_gt_name)
    ...
    img2_img_path =os.path.join(r"/mnt/Disk1/huangjin/breast_ultrasound/JIN_Work_algorithm/dataset_public/Dataset_BUSI_with_GT/BUSI_train_test/train/img/augment", "Contrast2_" + train_img_name)
    img2_gt_path = os.path.join(r"/mnt/Disk1/huangjin/breast_ultrasound/JIN_Work_algorithm/dataset_public/Dataset_BUSI_with_GT/BUSI_train_test/train/gt/augment", "Contrast2_" + train_gt_name)
    cv2.imwrite(img2_img_path,img2)
    shutil.copyfile(train_gt_path, img2_gt_path)


    img3 = Contrast_gamma(train_img_path, gamma=0.9)
    img3_img_path =  os.path.join(r"/mnt/Disk1/huangjin/breast_ultrasound/JIN_Work_algorithm/dataset_public/Dataset_BUSI_with_GT/BUSI_train_test/train/img/augment","Contrast3_" + train_img_name)
    img3_gt_path = os.path.join(r"/mnt/Disk1/huangjin/breast_ultrasound/JIN_Work_algorithm/dataset_public/Dataset_BUSI_with_GT/BUSI_train_test/train/gt/augment", "Contrast3_" + train_gt_name)
    cv2.imwrite(img3_img_path,img3)
    shutil.copyfile(train_gt_path, img3_gt_path)


    img4 = Light(train_img_path, value=20)
    img4_img_path =  os.path.join(r"/mnt/Disk1/huangjin/breast_ultrasound/JIN_Work_algorithm/dataset_public/Dataset_BUSI_with_GT/BUSI_train_test/train/img/augment", "Light1_" + train_img_name)
    img4_gt_path = os.path.join(r"/mnt/Disk1/huangjin/breast_ultrasound/JIN_Work_algorithm/dataset_public/Dataset_BUSI_with_GT/BUSI_train_test/train/gt/augment", "Light1_" + train_gt_name)
    cv2.imwrite(img4_img_path,img4)
    shutil.copyfile(train_gt_path, img4_gt_path)


    img5 = Light(train_img_path, value=50)
    img5_img_path = os.path.join(r"/mnt/Disk1/huangjin/breast_ultrasound/JIN_Work_algorithm/dataset_public/Dataset_BUSI_with_GT/BUSI_train_test/train/img/augment", "Light2_" + train_img_name)
    img5_gt_path = os.path.join(r"/mnt/Disk1/huangjin/breast_ultrasound/JIN_Work_algorithm/dataset_public/Dataset_BUSI_with_GT/BUSI_train_test/train/gt/augment", "Light2_" + train_gt_name)
    cv2.imwrite(img5_img_path,img5)
    shutil.copyfile(train_gt_path, img5_gt_path)


    img6 = Light(train_img_path, value=-10)
    img6_img_path =os.path.join(r"/mnt/Disk1/huangjin/breast_ultrasound/JIN_Work_algorithm/dataset_public/Dataset_BUSI_with_GT/BUSI_train_test/train/img/augment", "Light3_" + train_img_name)
    img6_gt_path = os.path.join(r"/mnt/Disk1/huangjin/breast_ultrasound/JIN_Work_algorithm/dataset_public/Dataset_BUSI_with_GT/BUSI_train_test/train/gt/augment", "Light3_" + train_gt_name)
    cv2.imwrite(img6_img_path,img6)
    shutil.copyfile(train_gt_path, img6_gt_path)

    img7 = Blur(train_img_path, blur=1)
    img7_img_path = os.path.join(r"/mnt/Disk1/huangjin/breast_ultrasound/JIN_Work_algorithm/dataset_public/Dataset_BUSI_with_GT/BUSI_train_test/train/img/augment", "Blur1_" + train_img_name)
    img7_gt_path = os.path.join(r"/mnt/Disk1/huangjin/breast_ultrasound/JIN_Work_algorithm/dataset_public/Dataset_BUSI_with_GT/BUSI_train_test/train/gt/augment", "Blur1_" + train_gt_name)
    cv2.imwrite(img7_img_path,img7)
    shutil.copyfile(train_gt_path, img7_gt_path)

    img8 = Blur(train_img_path, blur=2)
    img8_img_path = os.path.join(r"/mnt/Disk1/huangjin/breast_ultrasound/JIN_Work_algorithm/dataset_public/Dataset_BUSI_with_GT/BUSI_train_test/train/img/augment", "Blur2_" + train_img_name)
    img8_gt_path = os.path.join(r"/mnt/Disk1/huangjin/breast_ultrasound/JIN_Work_algorithm/dataset_public/Dataset_BUSI_with_GT/BUSI_train_test/train/gt/augment", "Blur2_" + train_gt_name)
    cv2.imwrite(img8_img_path,img8)
    shutil.copyfile(train_gt_path, img8_gt_path)


    img9 = Blur(train_img_path, blur=3)
    img9_img_path = os.path.join(r"/mnt/Disk1/huangjin/breast_ultrasound/JIN_Work_algorithm/dataset_public/Dataset_BUSI_with_GT/BUSI_train_test/train/img/augment", "Blur3_" + train_img_name)
    img9_gt_path = os.path.join(r"/mnt/Disk1/huangjin/breast_ultrasound/JIN_Work_algorithm/dataset_public/Dataset_BUSI_with_GT/BUSI_train_test/train/gt/augment", "Blur3_" + train_gt_name)
